          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../ijaszda/lovoter.php"><i class="fa fa-circle-o"></i> Lövőtér</a></li>
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="../ijaszda/lovoter.php" class="small-box-footer">
              Lővés <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="../ijaszda/vegetaciok.php" class="small-box-footer">
              Kiválasztás <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="../ijaszda/mentes.php" class="small-box-footer">
              Tobább <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        </div>
